    ...
    <div>
        ...
        <Row>
            ...
            <div style="" class="doc-header">
                ...
                <Date-picker type="daterange" placement="bottom-end" placeholder="选择日期"
                             style="width: 200px"></Date-picker>
                <Date-picker :value="value1" format="yyyy年MM月dd日" type="date" placeholder="选择日期"
                             style="width: 200px"></Date-picker>
                <Date-picker :value="value2" format="yyyy/MM/dd" type="daterange" placement="bottom-end"
        ...
        <Row>
            ...
            <div class="doc-content">
                <h5>手动控制组件</h5>
                <p对于一些定制化的场景
                ，可以使用 slot 配合参数 open 及事件来手动控制组件的显示状态，详见示例和 API</p>
            </div>
            </Col>
